...
var PlutonicationWalletClient = /** @class */ (function () {
    ...
    PlutonicationWalletClient.prototype.sendSignedPayloadAsync = function (signerResult) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
    ...
    PlutonicationWalletClient.prototype.sendSignedRawAsync = function (signerResult) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
